...
async function chain_passive_delete(runner) {
    const today = shared.today;
...
const ALL_CHAINS = ['preflight', 'basic', 'sidebar_tabs', 'readonly', 'adjust', 'seed', 'delete', 'passive_delete', 'crossday', 'crossday_adjust', 'cleanup_basic'];
